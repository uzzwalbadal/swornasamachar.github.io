...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-sm-12">
			...
			<div class="content">
				<div class="col-sm-3">			
					<img src="{{url('public/images/logo-dammer.png')}}" width="100%">
				</div>
				<div class="col-sm-9">
					<p><b><a href="http://www.dammerinvestmentcompany.com" target="_blank">dammerinvestmentcompany.com</a></b> The ultimate home for prospective web developers.</p>
					<div class="row">
					...
					<p>
						<a href="https://www.facebook.com/dammerinvestmentcompany/" target="_blank" class="btn btn-primary"><i class="fa fa-facebook"></i></a>
